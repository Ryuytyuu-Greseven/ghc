...
export class PatientsHelperService {
  buildList(entity: string) {
    return {
      data: [
        { id: '1', name: 'John Doe', age: 34, bloodGroup: 'O+', hospitalId: '1' },
        { id: '2', name: 'Jane Smith', age: 28, bloodGroup: 'A-', hospitalId: '2' },
      ],
      entity,
      count: 2,
    };
  ...
  buildRecord(entity: string, id: string) {
    return {
      data: { id, name: 'John Doe', age: 34, bloodGroup: 'O+', hospitalId: '1' },
      entity,
    };
  }
